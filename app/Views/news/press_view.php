            <!-- 내용 시작 -->
            <div id="press_view" class="press view">
                ...
                <section class="sec02 sec_common">
                    ...
                    <div class="tab_menu">
                        <ul>
                            <li class="active"><a href="/news#press">언론속의 이든</a></li>
                        ...
                        <div class="cont_wrap active">
                            ...
                            <div class="cont">
								<div class="view_info">
									...
									<!-- <a href="" target="_blank" class="go_to_article">기사바로가기</a> -->
								</div>
								<div class="view_inner">
                                    <?=$view['contents']?>
									<ul class="share_links">
										<li><button class="kakao_btn" id="kakao-share-btn" title="카카오톡 공유"></button></li>
										<li><button class="copy_btn" title="링크 복사"></button></li>
									</ul>
								</div>
								<div class="view_btm">
									<ul>
                                    <li><a class="prev_btn" href="<?= ($prev<$view['no'] && $prev>0)? '/news/view/'.$prev : '#' ?>"></a>이전 글</li>
                                    <li>다음 글<a class="next_btn" href="<?= ($next>$view['no'])? '/news/view/'.$next : '#'?>"></a></li>
									</ul>
								</div>
                                <a class="more_btn" href="/news#press">목록 보기</a>
							</div>
                        </div>
                    </div>
                </section>
